...
int main() {
    ...
    (Turismo1 > Turismo2) && printf("Carta 1 venceu!\n");
    (Turismo1 < Turismo2) && printf("Carta 2 venceu!\n");
    (Turismo1 == Turismo2) && printf("Empate!\n");
    printf("Densidade Populacional (Inversa): ");
    ((1 / Densidade1) < (1 / Densidade2)) && printf("Carta 1 venceu!\n");
    ((1 / Densidade1) > (1 / Densidade2)) && printf("Carta 2 venceu!\n");
    ((1 / Densidade1) == (1 / Densidade2)) && printf("Empate!\n");
    printf("Per Capita: ");
    (Capita1 > Capita2) && printf("Carta 1 venceu!\n");
    (Capita1 < Capita2) && printf("Carta 2 venceu!\n");
    (Capita1 == Capita2) && printf("Empate!\n");
    printf("Super Poder: ");
    (Poder1 > Poder2) && printf("Carta 1 venceu!\n");
    (Poder1 < Poder2) && printf("Carta 2 venceu!\n");
    (Poder1 == Poder2) && printf("Empate!\n");
